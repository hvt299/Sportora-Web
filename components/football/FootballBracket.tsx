...
import BracketNode from "./FootballBracketNode";
...
export default function Bracket({ data, fonts, category = 'football' }: { data: BracketData, fonts?: { base: string; heading: string; subHeading: string }, category?: string }) {
